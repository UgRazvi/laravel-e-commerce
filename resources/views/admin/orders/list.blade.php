                        ...
                        <tr class="text-center">
                            {{-- <td>
                                ...
                                <img src="{{ asset('uploads/Products/' . $item->product->product_images->first()->image) }}"
                                    alt="{{ $item->product->product_images->first()->image }}" class="" width="25"
                                    alt="Product Image" />
                                @else
                                <img src="{{ asset('uploads/Products/DummyImage.png') }}" class="" width="25"
                            ...
                            {{-- {{ \Carbon\Carbon::parse($order->created_at)->format('D, j M Y h:i:s A') }}  --}}
                            </td>
                            <td>
