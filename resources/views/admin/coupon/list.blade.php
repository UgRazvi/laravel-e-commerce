                            ...
                            @if ($discountCoupon->isNotEmpty())
                                @foreach ($discountCoupon as $coupon)
                                    <tr class="text-center">
                                        ...
                                        <td>{{ $coupon->starts_at ? \Carbon\Carbon::parse($coupon->starts_at)->format('Y/m/d H:i:s') : '' }}
                                        </td>
                                        <td>{{ $coupon->expires_at ? \Carbon\Carbon::parse($coupon->starts_at)->format('Y/m/d H:i:s') : '' }}
                                        </td>
