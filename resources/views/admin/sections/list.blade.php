        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('sections.create') }}" class="btn btn-primary">New Sections</a>
                </div>
            </div>
        </div>
        {{-- <!-- /.container-fluid --> --}}
                ...
                <form action="" method="get">
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick="window.location.href='{{ route('sections.index') }}'"
                                ...
                                @foreach ($sections as $section)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- Delete - Category --}}
                                            <a href="" onclick="deleteCategory({{ $section->id }})"
