...
// dd("theme_clr", $theme_clr);

// Define other colors
$bs_primary = getPrimary();
$bs_primary_hover = getPrimaryHOver();
$bs_gray = getBsgray();
$bs_secondary = getBssecondary();
$bs_success = getBssuccess();
$bs_info = getBsinfo();
$bs_warning = getBswarning();
$bs_light = getBslight();
$bs_dark = getBsdark();
$bs_danger = getTheme();
...
<style>
    ...
    :root {
        ...
        --bs-gray: <?php echo $bs_gray; ?>;
        --bs-secondary: <?php echo $bs_secondary; ?>;
        --bs-success: <?php echo $bs_success; ?>;
        --bs-info: <?php echo $bs_info; ?>;
        --bs-warning: <?php echo $bs_warning; ?>;
        --bs-danger: <?php echo $bs_danger; ?>;
        --bs-light: <?php echo $bs_light; ?>;
        --bs-dark: <?php echo $bs_dark; ?>;

        --bs-secondary-rgb: 108, 117, 125;
        --bs-success-rgb: 25, 135, 84;
        --bs-info-rgb: 13, 202, 240;
        --bs-warning-rgb: 255, 193, 7;
        --bs-danger-rgb: <?php echo $bs_danger; ?>;
    ...
    *::after {
    ...
    a:hover {
        /* color: #0a58ca; */
        color: <?php echo getPrimaryHover(); ?>;
    }
    ...
    .btn-primary:hover {
        ...
        /* border-color: #0a58ca; */
        border-color: <?php echo getPrimaryHover(); ?>;
    }
    ...
    .show > .btn-primary.dropdown-toggle {
        ...
        background-color: <?php echo getPrimaryHover(); ?>;
        border-color: #0a53be;
    }
    ...
    *:visited {
    ...
    .text-primary {
        /* color: <?php echo $clr_yellow; ?> !important; */
        color: #000 !important;
    }
    .text-secondary {
        color: #001d3d;
    ...
    .btn-dark:hover {
        background-color: <?php echo $clr_yellow; ?>;
        border-color: <?php echo $clr_yellow; ?>;
    }
    .logo a span {
        /* font-family: "Roboto"; */
        font-family: "Assistant";
    ...
    .section-3 .cat-card .right:hover {
        /* background-color: <?php echo $clr_yellow; ?>; */
        /*  Yellow Color */
        background-color: <?php echo $theme_clr; ?>; /* Pink Color */
        color: #fff;
    }
