    ...
    <div id="Login_form" class="container pt-4">
        <div class="row justify-content-center">
            <div class="col-12 col-md-5 col-lg-4">
                ...
                <form class="bg-white p-4 shadow" action="{{ route('front.processResetPassword') }}" method="post"
                    name="processResetPasswordForm" id="processResetPasswordForm">
                    @csrf
                    ...
                    <div class="mt-4">
                        <div class="input-group" style="border: 1px solid grey;">
                            <input type="email" class="form-control @error('email') is-invalid @enderror border-0"
                                id="email" name="email" placeholder="Enter E-Mail" title="Enter Correct E-Mail"
                                value="{{ old('email') }}">
                        </div>
                        @error('email')
                    ...
                    <div class="mt-4">
                        <div class="input-group" style="border: 1px solid grey;">
                            <input type="password"
                                class="form-control border-0 @error('new_password') is-invalid @enderror"
                                id="new_password" name="new_password" placeholder="New Password" title="New Password"
                    ...
                    <div class="mt-4">
                        <div class="input-group" style="border: 1px solid grey;">
                            <input type="password"
                                class="form-control border-0 @error('confirm_password') is-invalid @enderror"
                                id="confirm_password" name="confirm_password" placeholder="Confirm Password"
                                title="Confirm Password" value="{{ old('confirm_password') }}">
                        </div>
