        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-5 col-lg-4">
                ...
                {{-- <form class="bg-white p-4 shadow" action="" method="post" name="registrationForm"
                    ...
                    <div class="mt-4">
                        <div class="input-group" style="border: 1px solid grey;">
                            <input type="text" class="form-control @error('name') is-invalid @enderror border-0"
                                id="name" name="name" placeholder="Enter Name" title="Enter Correct Name">
                        </div>
                        @error('name')
                    ...
                    <div class="mt-4">
                        <div class="input-group" style="border: 1px solid grey;">
                            <input type="text" class="form-control @error('email') is-invalid @enderror border-0"
                    ...
                    <div class="mt-4">
                        <div class="input-group" style="border: 1px solid grey;">
                            <input type="text"
                                class="form-control @error('password') is-invalid @enderror border-0" id="password"
                    ...
                    <div class="mt-4">
                        <div class="input-group" style="border: 1px solid grey;">
                            <input type="text"
                                class="form-control @error('password_confirmation') is-invalid @enderror border-0"
